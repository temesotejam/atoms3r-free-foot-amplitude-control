...
String Profile::json() const {
  ...
  out = "{\"revision\":\"control_work_04713\",\"scope\":\"measurement_only;host_wall_time_includes_preemption;nested_stages_not_additive\"";
  ...
  out += ",\"log_encoder\":\"GCC_O2_no_fast_math_inline_constant_scales\",\"log_substages\":\"encode_includes_beta_ceilings;store_is_synchronous_psram_addSample\"";
